...
var _myInfo = _interopRequireDefault(__webpack_require__(/*! ./pages/my/myInfo.vue */ 188));
// @ts-ignore
...
/* harmony import */ var _myInfo_vue_vue_type_template_id_46427794_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./myInfo.vue?vue&type=template&id=46427794&scoped=true& */ 189);
/* harmony import */ var _myInfo_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./myInfo.vue?vue&type=script&lang=js& */ 191);
...
/* harmony import */ var _myInfo_vue_vue_type_style_index_0_id_46427794_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./myInfo.vue?vue&type=style&index=0&id=46427794&lang=scss&scoped=true& */ 194);
...
try {
  components = {
    ...
    uGrid: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-grid/u-grid */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-grid/u-grid")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-grid/u-grid.vue */ 513))
    },
    uGridItem: function () {
      return Promise.all(/*! import() | uni_modules/uview-ui/components/u-grid-item/u-grid-item */[__webpack_require__.e("common/vendor"), __webpack_require__.e("uni_modules/uview-ui/components/u-grid-item/u-grid-item")]).then(__webpack_require__.bind(null, /*! @/uni_modules/uview-ui/components/u-grid-item/u-grid-item.vue */ 521))
    },
  }
} catch (e) {
  if (
...
var render = function () {
  ...
  var f0 =
    _vm.userInfo.token && _vm.userInfo.phoneNum
      ? _vm._f("phone")(_vm.userInfo.phoneNum)
      : null
...
var _default = {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)(['setLoginPopupShow'])), {}, {
    ...
    upac: function upac() {
      ...
      (0, _api.getUserLoginUpAvatar)("http://192.168.159.136:9000/wisdom/wisdom/2023/11/30/2dc6a24b3d5e422e8a0575ca13dabff1.jpeg").then(function (ress) {
        debugger;
      });
    },
    ups: function ups() {
      var data = {};
      (0, _api.getUserList)(data).then(function (res) {
        console.log(res);
      });
    },
    // 跳转前判断登录
    ...
    navClick: function navClick(e) {
      ...
      if (e == 'goMyAddressList') {
        ...
        this.ups();
      } else if (e == 'onHelp') {} else if (e == 'goFeedback') {
