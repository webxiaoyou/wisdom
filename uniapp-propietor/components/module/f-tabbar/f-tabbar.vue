		...
		data() {
			return {
				...
				list: [{
						...
						icon: require('@/static/my-icon/home.svg'),
						iconFill: require('@/static/my-icon/home-filling.svg')
					},
					{
						name: '消息',
						url: 'pages/news/news',
						icon: require('@/static/my-icon/caht.svg'),
						iconFill: require('@/static/my-icon/caht-filling.svg'),
						// badge: 16
					},
					{
						name: '我的',
						url: 'pages/my/myInfo',
						icon: require('@/static/my-icon/my.svg'),
						iconFill: require('@/static/my-icon/my-filling.svg'),
						// dot: true
					}
				]
			}
