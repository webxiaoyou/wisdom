                ...
                <a-form ref="formRefs" :model="formState" :rules="rules">
                    <a-row>
                        <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            <a-form-item label="通知标题" name="title" :labelCol="labelCol">
                            ...
                            <a-form-item ref="targetId" label="楼栋选择" name="targetId" v-if="formState.targetType=='0'" :labelCol="labelCol">
                                <a-select placeholder="请选择楼栋"  show-search v-model:value="formState.targetId">
                                    <a-select-option :value="item.value" v-for="item in buildings"
                                        :key="item.value">{{
                                            item.label }}</a-select-option>
                                </a-select>
                            </a-form-item>
                            <a-form-item ref="targetId" label="用户选择" name="targetId" v-if="formState.targetType=='1'" :labelCol="labelCol">
                                <a-select placeholder="请选择用户"  show-search v-model:value="formState.targetId">
                        ...
                        <a-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
                            ...
                            <a-form-item ref="targetType" label="接收对象" name="targetType" :labelCol="labelCol">
                                <a-select placeholder="请选择接收对象" v-model:value="formState.targetType" @change="handleChange">
                                    <a-select-option :value="item.dictValue" v-for="item in distList?.target_type"
                                        :key="item.dictValue">{{
                                            item.dictLabel }}</a-select-option>
                                </a-select>
                            </a-form-item>
