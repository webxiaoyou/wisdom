package com.wisdom.framework.handler;
...
public class OpenApiHandler extends OpenAPIService {
     ...
     * @param openApiBuilderCustomizers OpenAPI 构建定制器列表
